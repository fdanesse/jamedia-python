...
setup(
    ...
    url = "http://fdanesse.byethost8.com/jamedia/",
    license = "LGPL 3",

    scripts = ["jamedia", "jamedia_uninstall"],
    ...
    data_files =[
        ...
        ("JAMediaPlayer/JAMediaReproductor/",[
            "JAMediaPlayer/JAMediaReproductor/JAMediaReproductor.py",
            "JAMediaPlayer/JAMediaReproductor/JAMediaGrabador.py",
            "JAMediaPlayer/JAMediaReproductor/__init__.py",
            "JAMediaPlayer/JAMediaReproductor/JAMediaBins.py"]),

        ("JAMediaPlayer/",[
            "JAMediaPlayer/BasePanel.py",
            "JAMediaPlayer/Toolbars.py",
            "JAMediaPlayer/ProgressPlayer.py",
            "JAMediaPlayer/JAMediaPlayer.py",
            "JAMediaPlayer/Derecha.py",
            "JAMediaPlayer/BalanceWidget.py",
            "JAMediaPlayer/Widgets.py",
            "JAMediaPlayer/IzquierdaWidgets.py",
            "JAMediaPlayer/PlayerControls.py",
            "JAMediaPlayer/JAMediaPlayerList.py",
            "JAMediaPlayer/Izquierda.py",
            "JAMediaPlayer/__init__.py",
            "JAMediaPlayer/Globales.py"]),
...
import commands
commands.getoutput("chmod 755 /usr/bin/jamedia")
commands.getoutput("chmod -R 755 /usr/share/JAMedia")
commands.getoutput("chmod 755/usr/applications/JAMedia.desktop")
