...
youtubedllauncher = os.path.join(os.path.dirname(__file__), "yt-dlp")
# STDERR = "/dev/null"

# FIXME: Ejemplos para embeber la libreria: https://github.com/yt-dlp/yt-dlp#embedding-examples
